...
source <(fzf --zsh)
# if fzf version is < 0.48 use these lines
...
. "/home/robinw/.deno/env"
# pnpm
export PNPM_HOME="/home/robinw/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
# fnm
FNM_PATH="/home/robinw/.local/share/fnm"
if [ -d "$FNM_PATH" ]; then
...
# bun completions
[ -s "/home/robinw/.bun/_bun" ] && source "/home/robinw/.bun/_bun"
